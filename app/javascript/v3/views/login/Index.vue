...
<template>
  <PortaInn>
    ...
    <div v-else-if="email" class="flex items-center justify-center">
    ...
    <div v-else :class="{ 'animate-wiggle': loginApi.hasErrored }">
      <div class="flex flex-col gap-4">
        ...
        <router-link
          v-if="showSamlLogin"
          to="/app/login/sso"
          class="inline-flex items-center justify-center w-full px-4 py-3 rounded-md shadow-sm bg-n-background ring-1 ring-inset ring-n-container hover:bg-n-alpha-2"
        >
      ...
      <form class="mt-5 space-y-5" @submit.prevent="submitFormLogin">
        <FormInput
      ...
      <p v-if="showSignupLink" class="porta__rodape">
        {{ $t('COMMON.OR') }}
