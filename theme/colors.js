const { blue, blueDark, slate, slateDark, violet, violetDark, green, greenDark, yellow, yellowDark, red, redDark } = require('./innagent-radix');

export const colors = {
  // innagent: acao e tinta — o primario do motor aponta para a rampa NEUTRA.
  // O azul segue existindo em `blue`, para link, foco e estado.
  woot: {
    25: slate.slate2,
    50: slate.slate3,
    75: slate.slate4,
